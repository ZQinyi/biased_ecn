...
void HomaAgent::sendmsg(hdr_homa *homa_hdr, int prio, const char *flags)
{
    ...
    while (n-- > 0)
    {
        ...
        // set a random flow id to effectively achieve per packet spraying (?)
        // TODO: correct understanding of packet spraying? (NO)
        hdr_ip::access(p)
        ...
        // eth 14, ip 20, udp 8, r2p2 8 // TODO: REVISE
