...
// TODO: RE-EVALUATE whether it makes sense for HomaTransport to extend R2p2Transport after duplicating
// agent functionality.
// Currently used for "$clientApplication($app) attach-r2p2-layer $rdTransportLayer($host)"
// and for $rdTransportLayer($i) start-tracing $results_path
/**
