...
void hysup::Receivers::update_policy_state(int32_t this_addr)
{
    ...
    // TODO: This is highly unscalable with the number of receivers...
    int num_can_send = 0;
...
uint64_t hysup::Stats::num_data_pkts_of_SRPT_msg_sent_[3] = {0};
double hysup::Stats::ratio_data_pkts_of_SRPT_msg_sent_[3] = {0.0};
uint64_t hysup::Stats::num_credit_pkts_sent_ = 0;
uint64_t hysup::Stats::num_credit_pkts_of_SRPT_msg_sent_[3] = {0};
double hysup::Stats::ratio_credit_pkts_of_SRPT_msg_sent_[3] = {0.0};
