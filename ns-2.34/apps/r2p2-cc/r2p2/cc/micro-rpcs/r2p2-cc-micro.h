...
#define POLL_SAMPLE_GAP 20 // once every 100 us at 100Gbps
// #define POLL_SAMPLE_GAP 834 // once every 50 us at 100Gbps
...
protected:
    ...
    std::unordered_map<int32_t, hysup::SenderState *> sender_state_;
    ...
    int sender_algo_; // 0: DCTCP, 1: HPCC
    double eta_;
    uint32_t wai_;
    uint32_t max_stage_;
