...
set ptype(aomdv) 61\n\
set pvals(61) AOMDV\n\
set ptype(multimedia) 62\n\
set pvals(62) Multimedia\n\
set ptype(r2p2) 63\n\
set pvals(63) R2P2\n\
set ptype(xpass_credit_request) 64\n\
set pvals(64) XPASS_CREDIT_REQUEST\n\
set ptype(xpass_credit_stop) 65\n\
set pvals(65) XPASS_CREDIT_STOP\n\
set ptype(xpass_credit) 66\n\
set pvals(66) XPASS_CREDIT\n\
set ptype(xpass_data) 67\n\
set pvals(67) XPASS_DATA\n\
set ptype(xpass_nack) 68\n\
set pvals(68) XPASS_NACK\n\
proc ptype2val {str} {\n\
global ptype\n\
