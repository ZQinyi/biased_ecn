...
\"\n\
checkout_executable TCLSH \"/home/aqq/nwsim/ns2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/aqq/nwsim/ns2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
puts \"nodecolor $nodecolor_ DELETEME:)\"\n\
...
R2P2_CC_MICRO/HYBRID set sender_srpt_ -1\n\
